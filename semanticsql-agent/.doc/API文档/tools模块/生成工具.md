...
class ScenarioToolInput(BaseModel):
    ...
    # 注意：ScenarioTool 不使用 memory 参数，它基于预定义模板工作
```
...
```python
{
    "scenario_id": "scenario_0_143025",
    "category": "销售分析",
    "business_purpose": "分析特定时间段的销售业绩",
    "description": "查询某个时间段内的销售总额、订单数量等关键指标",
    "complexity": "medium",
    "applicable_operations": ["JOIN", "GROUP", "SUM", "COUNT"],
    "template_id": "sales_analysis_001"
}
```
...
Observation: {
    ...
    "complexity": "medium",
    "applicable_operations": ["JOIN", "GROUP", "HAVING"],
    "description": "分析客户购买行为和价值",
    "template_id": "customer_value_001"
}
```
