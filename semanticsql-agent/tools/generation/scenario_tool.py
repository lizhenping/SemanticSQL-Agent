...
from core.models import QueryScenario, DifficultyLevel, SQLOperation
from core.constants import SCENARIO_CATEGORIES, DIFFICULTY_DISTRIBUTION
...
class ScenarioTool(BaseTool):
    ...
    def _infer_category(self, table_name: str) -> str:
        ...
        # 默认类别
        return random.choice(SCENARIO_CATEGORIES)
