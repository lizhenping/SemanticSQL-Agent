...
- `agent/base_agent.py` - LangChain agent base class
- `agent/sql_agent.py` - Production SQL agent
- `config/settings.py` - Pydantic configuration models
- `utils/memory.py` - LangChain memory implementation
- `utils/trajectory.py` - Execution tracking
- `tools/` - Complete tool ecosystem (14+ tools)
...
### Debugging
- **Trajectory Files**: Saved in `trajectories/` directory
- **Logging**: Structured logging with tool execution details
